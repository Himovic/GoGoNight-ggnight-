...
public class FriendControl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(HiddenAddFriend != null){
			...
			if(addFriend){
				returnResult = "Invitation envoy�e";
			}else{
				returnResult = "Un probl�me est apparu! refaire a nouveau!";
			}
		...
		if(HiddenRejectFriendRequest != null){
			...
			String returnResult = "";
			if(confirmeReject){
				returnResult = "Invitation annul�e avec succ�es";
			}else{
		...
		if(HiddenConfirmFriendRequest != null){
			...
			if(confirmeAccept){
				returnResult = "Demande d'ami accept�e";
			}else{
				returnResult = "Une �rreur est apparue ! refaire a nouveau!";
			}
			response.setContentType("text/plain");
			response.getWriter().write(returnResult);
		}
		...
		if(HiddenDeleteFriend != null){
			...
			if(deleteFriend){
				returnResult = "Suppr�ssion confirm�e";
			}else{
				returnResult = "Une �rreur est apparue ! refaire a nouveau!";
			}
			response.setContentType("text/plain");
